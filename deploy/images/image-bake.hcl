...
# Optional build network args shared by all targets.
...
group "default" {
  targets = ["platform-auth-service", "platform-model-service", "platform-provider-service", "platform-network-service", "platform-profile-service", "platform-support-service", "platform-agent-runtime-service", "notification-dispatcher", "wecom-callback-adapter", "platform-chat-service", "console-api", "console-web", "agent-runtime-egress-auth-wasm", "control-plane-egress-auth-wasm"]
}
...
target "agent-runtime-egress-auth-wasm" {
  ...
  tags       = ["${IMAGE_REGISTRY}code-code/agent-runtime-egress-auth-wasm:${IMAGE_TAG}"]
}
...
target "control-plane-egress-auth-wasm" {
  ...
  tags       = ["${IMAGE_REGISTRY}code-code/control-plane-egress-auth-wasm:${IMAGE_TAG}"]
}
