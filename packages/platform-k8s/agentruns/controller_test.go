...
func newClient(objects ...ctrlclient.Object) ctrlclient.Client {
	baseObjects := []ctrlclient.Object{sourceCredentialSecret()}
...
func sourceCredentialSecret() *k8scorev1.Secret {
	return &k8scorev1.Secret{
		ObjectMeta: metav1.ObjectMeta{Name: "credential-openai-secret", Namespace: "code-code"},
		Type:       k8scorev1.SecretTypeOpaque,
		Data: map[string][]byte{
			"api_key": []byte("sk-test"),
		},
	}
}
