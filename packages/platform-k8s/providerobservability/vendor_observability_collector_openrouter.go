...
func (c *openrouterVendorObservabilityCollector) Collect(ctx context.Context, input VendorObservabilityCollectInput) (*VendorObservabilityCollectResult, error) {
	...
	if apiKey == "" {
		return nil, unauthorizedVendorObservabilityError("openrouter quotas: api key is required; configure observability_credential_ref or primary_credential_ref")
	}
