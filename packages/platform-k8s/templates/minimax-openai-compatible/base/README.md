# MiniMax OpenAI-Compatible Base

这个目录是 `MiniMax` 的 `Kustomize base`。
...
- 在自己的 overlay 里替换：
  ...
  - secret name
  - model ids
- 默认 `baseUrl` 使用 `https://api.minimaxi.com/v1`
- 如果你的 MiniMax key 属于国际站，再在 overlay 中改成 `https://api.minimax.io/v1`
