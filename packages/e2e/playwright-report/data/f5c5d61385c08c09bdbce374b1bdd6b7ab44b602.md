...
- Name: 09-error-handling.spec.ts >> 404 与错误处理 >> 访问不存在的 Runner 编辑页应有合理反馈
- Location: tests/09-error-handling.spec.ts:31:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/agent-runners/nonexistent-id/edit
Call log:
  - navigating to "http://localhost:5174/agent-runners/nonexistent-id/edit", waiting until "load"
