...
- Name: 04-navigation-layout.spec.ts >> 全局导航结构 >> 点击 Projects 应回到项目列表
- Location: tests/04-navigation-layout.spec.ts:51:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/skills
Call log:
  - navigating to "http://localhost:5173/skills", waiting until "load"
