...
- Name: 09-error-handling.spec.ts >> 404 与错误处理 >> 访问不存在的路由应有合理反馈
- Location: tests/09-error-handling.spec.ts:38:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/this-route-does-not-exist
Call log:
  - navigating to "http://localhost:5174/this-route-does-not-exist", waiting until "load"
