...
- Name: 09-error-handling.spec.ts >> 404 与错误处理 >> 访问不存在的 Skill 编辑页应有合理反馈
- Location: tests/09-error-handling.spec.ts:13:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/skills/nonexistent-id/edit
Call log:
  - navigating to "http://localhost:5174/skills/nonexistent-id/edit", waiting until "load"
