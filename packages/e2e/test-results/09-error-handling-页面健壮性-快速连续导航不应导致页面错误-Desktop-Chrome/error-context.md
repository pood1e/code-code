...
- Name: 09-error-handling.spec.ts >> 页面健壮性 >> 快速连续导航不应导致页面错误
- Location: tests/09-error-handling.spec.ts:123:7
...
- generic [ref=e2]:
  - generic [ref=e3]:
    ...
    - main [ref=e43]:
      - generic [ref=e47]:
        - generic [ref=e48]:
          - heading "暂无 AgentRunners" [level=3] [ref=e49]
          - paragraph [ref=e50]: 还没有任何 AgentRunner，先创建一个新的 AgentRunner。
        - button "新建 AgentRunner" [ref=e52]:
          - img
          - text: 新建 AgentRunner
